            ...
            <main class="flex-1 max-w-[1280px] mx-auto w-full px-4 lg:px-40 py-8 space-y-12">
                <section class="@container">
                    <div
                        ...
                        <div class="w-full lg:w-3/5 bg-center bg-no-repeat aspect-video lg:aspect-auto bg-cover"
                        ...
                        <div class="flex flex-col gap-6 p-8 lg:p-12 lg:w-2/5 justify-center">
                            <div class="flex flex-col gap-3">
                                <span class="text-primary font-bold tracking-widest text-xs uppercase">New
                                    Arrival</span>
                                <h1
                ...
                <section class="space-y-4">
                    <div class="flex items-center justify-between px-2">
                        <h2 class="text-[#111418] dark:text-white text-2xl font-black leading-tight tracking-tight">New
                            Arrivals</h2>
                ...
                <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div
                        ...
                        <div class="relative h-64 overflow-hidden bg-[#f1f5f9] dark:bg-[#2d333a]">
                            <div class="absolute inset-0 bg-center bg-no-repeat bg-cover transition-transform duration-500 group-hover:scale-110"
                ...
                <section class="grid grid-cols-1 md:grid-cols-2 gap-6 pb-12">
                    <div class="relative rounded-2xl overflow-hidden group h-[300px]">
                        <div class="absolute inset-0 bg-center bg-no-repeat bg-cover transition-transform duration-700 group-hover:scale-105"
